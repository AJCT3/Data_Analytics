	...
	--print @MonthEnd
	 ...
	 if OBJECT_ID('tempdb..#temp1') is not null
		...
		*
		into #Temp1
		from [ldndw1\reporting].[Informatics_Reporting].[etl].[vw_ClaimGeneral] with (nolock) 
    ...
    if OBJECT_ID('tempdb..#temp2') is not null
		...
		*
		into #Temp2
		from [ldndw1\reporting].[Informatics_Reporting].[etl].[vw_ClaimRiskCategory] with (nolock) 
